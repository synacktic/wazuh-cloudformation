...
sed -i "s|'http://YOUR_ELASTIC_SERVER_IP:9200'|'10.16.2.123','10.16.2.124','10.16.2.125'|" /etc/filebeat/filebeat.yml
...
sshpass -f pass scp -o "StrictHostKeyChecking=no" wazuh@10.16.2.124:/home/wazuh/certs.zip /home/wazuh/
rm pass -f
...
until curl -XGET "https://10.16.2.123:9200" -k -u elastic:${ssh_password}; do
    sleep 5
